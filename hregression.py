...
data = pd.read_csv("dc_sip no_treatment.csv")
...
X = data[['stemp','atemp','ppt','tmax','tmin']]

y = data['totsysc']

df= data[['stemp','tmax','tmin','atemp','ppt']]
...
#     "Predicted":predictions
# })
# writer = pd.ExcelWriter('not_carbon_harvard.xlsx', engine='xlsxwriter')
# CSV4.to_excel(writer, sheet_name='Sheet1')
# writer.save()
